...
public abstract class ShipController {
    ...
    public void setCompoentsProp(StackPane layeredPane, ViewComponent comp) {
        // Default implementation does nothing
        return;
    }

    public void setCompoentsProp(StackPane layeredPane, ViewBattery comp) {
    ...
    public void setCompoentsProp(StackPane layeredPane, ViewCabin comp) {
        if (comp.alien) {
    ...
    public void setCompoentsProp(StackPane layeredPane, ViewCargoHold comp) {
        // TODO
        return;
    }
